        ...
        content
            .background(
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    .fill(elevated ? ILTheme.backgroundElevated : ILTheme.backgroundSecondary)
            )
            ...
            .shadow(color: accent.mid.opacity(0.06), radius: 24, x: 0, y: 8)
    }
}
